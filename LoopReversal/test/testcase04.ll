; ModuleID = '/home/aayusphere/ACE/llvm-project/LLVM_IR/test/code/testcase04.cpp'
source_filename = "/home/aayusphere/ACE/llvm-project/LLVM_IR/test/code/testcase04.cpp"
...
@.str = private unnamed_addr constant [18 x i8] c"Sum of elements: \00", align 1
@llvm.global_ctors = appending global [1 x { i32, ptr, ptr }] [{ i32, ptr, ptr } { i32 65535, ptr @_GLOBAL__sub_I_testcase04.cpp, ptr null }]
...
; Function Attrs: noinline uwtable
define internal void @_GLOBAL__sub_I_testcase04.cpp() #0 section ".text.startup" {
